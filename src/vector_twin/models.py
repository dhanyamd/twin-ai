...
@lru_cache(maxsize=1) 
def intialize_models() -> tuple[torch.device, MTCNN, InceptionResnetV1]: 
    """Intialises and returns the required ML models and device for face recognition 
    
    This function sets up he device intialises the MTCNN model for face detection and loads 
    a pre-trained InceptionResnetV1 model for generating face mebeddings. 
