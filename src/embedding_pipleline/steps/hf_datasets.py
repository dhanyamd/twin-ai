...
def load_hf_dataset(dataset_name: str = "lansinuote/simple_facenet") -> Dataset:
    ...
    This function loads the dataset sepcified by the DATASET_NAME constant using 
    HuggingFace datasets libarary. It prints info abt available splits and the size of 
...
def sample_dataset(dataset: Dataset, sample_size: int = 3000) -> Dataset: 
    """Creates a random sample from the given dataset 
